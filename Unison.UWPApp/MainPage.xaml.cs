...
namespace Unison.UWPApp
{
    ...
    {
        public WhatsAppService Service => WhatsAppService.Instance;
        ...
        private void NavListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                // Clear selection in the other list to simulate a single navigation container
                ...
                if (sourceList.SelectedItem is ListViewItem item)
                {
                    ...
                    if (tag == "chats")
                    {
                        if (DebugPart != null) DebugPart.Visibility = Visibility.Collapsed;
                        if (RootContentGrid != null) RootContentGrid.Visibility = Visibility.Visible;
                    }
                    else if (tag == "debug")
                    {
                        if (DebugPart != null) DebugPart.Visibility = Visibility.Visible;
                    }
        ...
        {
            if (DebugPart == null || ChatDetailPart == null || LayoutStates == null) return;
        ...
        private void Page_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            {
                // Narrow State
                if (ChatDetailPart.Visibility == Visibility.Visible)
                {
                    Column0.Width = new GridLength(0);
                    Column1.Width = new GridLength(1, GridUnitType.Star);
                }
                ...
                Column0.MaxWidth = double.PositiveInfinity;
            }
            else
            {
                // Wide State
                Column0.MaxWidth = 400;
                Column0.Width = new GridLength(320);
                Column1.Width = new GridLength(1, GridUnitType.Star);
                ChatListPart.Visibility = Visibility.Visible;
                ChatDetailPart.Visibility = Visibility.Visible;
            }
