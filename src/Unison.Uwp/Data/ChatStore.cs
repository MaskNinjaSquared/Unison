...

{
...

    {
        ...
        public Task<ChatLocalState> SetWidgetPinnedAsync(string jid, bool isWidgetPinned)
        ...
        public Task<ChatLocalState> SetChatPinnedAsync(string jid, bool isChatPinned)
        ...
        public Task<ChatLocalState> SetMutedUntilAsync(string jid, long? mutedUntil)
        ...
        public Task<ChatLocalState> SetStatusAsync(string jid, ChatLocalStatus status)
